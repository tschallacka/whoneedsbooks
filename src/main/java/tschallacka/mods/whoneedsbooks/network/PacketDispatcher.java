...
public class PacketDispatcher
{
	...
	public static final void sendToAllAround(IMessage message, World world, BlockPos pos, double range) {
		sendToAllAround(message, world.provider.getDimension(), (double)pos.getX(), (double)world.getHeight(pos).getY(), (double)pos.getZ(), range);
	}
	/**
	 ...
	 * Shortcut to {@link SimpleNetworkWrapper#sendToAllAround(IMessage, NetworkRegistry.TargetPoint)}
	 */
	public static final void sendToAllAround(IMessage message, TileEntity entity, double range) {
		BlockPos pos = entity.getPos();
		PacketDispatcher.sendToAllAround(message, entity.getWorld().provider.getDimension(), pos.getX(), pos.getY(), pos.getZ(), range);
	}
	/**
